    ...
    try {
      ...
      if (res.ok && data.ads?.length > 0) {
        ...
        setFormData({
          ...
          expiryDate: new Date(ad.expiryDate).toISOString().split('T')[0],
  ...
  if (fetchLoading) {
    return (
      <div className="p-6 max-w-4xl mx-auto">
        <div className="text-center py-12">Loading ad...</div>
      </div>
    )
  }
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold mt-2">Edit Ad</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-6">
        ...
        <div>
          <label className="block text-sm font-medium mb-2">
            Media File (Upload new to replace)
          </label>
          <input
            type="file"
            accept="image/*,video/*"
